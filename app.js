...
const calcular=()=>{
  ...
  <td>$ ${(a*200).toFixed(2)}</td>
      ...
      <td>$ ${(sb*0.45).toFixed(2)}</td>
            ...
            <tr>
            <td class="bg-danger text-white h2">TOTAL DE PERCEPCIONES</td>
    ...
    <td>SALUD</td>
      <td>$ ${(sb*0.0465).toFixed(2)}</td>
        ...
        <td>$ ${(sb*061).toFixed(2)}</td>
          ...
          <tr>
          <td class="bg-danger text-white h2">TOTAL DE DEDUCCIONES </td>
      ...
      <tr>
      <td class="h1">$ ${((sb+(sb*0.02)+(sb*0.045)+extra+(a*200))+((sb*1.16)+(sb*0.0465)+(sb*0.465)+(sb*0.061)+(sb*0.014))).toFixed(2)}</td>
      </tr>
      </table>
      `
}
